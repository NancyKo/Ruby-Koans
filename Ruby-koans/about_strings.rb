...
class AboutStrings < Neo::Koan
  ...
  def test_use_single_quotes_to_create_string_with_double_quotes
    ...
    # escaping the double quotes on its own automatically instead of me writing it out: 
    # 'He said, \"Go Away.\"'
  end
  ...
  def test_use_double_quotes_to_create_strings_with_single_quotes
    ...
    # better practice to use single quotes on outside and using double quotation mark on inside. 
  end
